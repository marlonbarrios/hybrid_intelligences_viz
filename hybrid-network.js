...
const NODES = [
  ...
  { id: "enact",              label: "Enact",                         cat: "practice",   weight: 1.5,
    desc: "Cognitive prompts for a choreography of awareness — short invitations, in the spirit of Oblique Strategies, generated from Hybrid Intelligences. Meant for crowded rooms as much as quiet ones: phones, plates, badges, chairs, demos, other bodies. The change is attention and a tiny shift of weight or glance — not a new task and not leaving the place. Thinking, writing, remembering, and imagining futures are already coupled with tools and others; nothing is only inside the body. Tap for another. Marin can speak the invitation.",
