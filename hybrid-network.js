...
const NODES = [
  ...
  { id: "conversational_ai",  label: "Conversational\nAI",            cat: "practice",   weight: 1.55,
    desc: "The spoken companion for the Hybrid Intelligences Hub — one layer of a dynamic cognitive assemblage created by Marlon Barrios Solano. Grounded in the ontology as its knowledge base, it explains concepts from their definitions and relations, can be interrupted, and opens from Talk about this on any node. When asked what this tool or hub is, it should describe the Hub itself: essays, ontology, network, Voice, Image, and Mini-pod coupled as one instrument — not a chatbot standing alone.",
    url: "voice.html", linkLabel: "Open Voice →" },
  { id: "ontology_kb",        label: "Ontology as\nKnowledge Base",   cat: "practice",   weight: 1.55,
    desc: "The Hybrid Intelligences ontology as a living vocabulary that grounds the conversational AI. Concepts, definitions, and weighted relations are the source of truth the spoken companion is given — a situated knowledge base rather than a generic model talking about the program from outside. Essays feed this scheme; the network makes it visible; Voice, Image, and Mini-pod generate from it.",
