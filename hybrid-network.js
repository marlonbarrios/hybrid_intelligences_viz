...
const NODES = [
  ...
  { id: "three_es_ai",        label: "3 E's of\nAI Impact",           cat: "framework",  weight: 1.5,
    desc: "Kate Crawford's framework for mapping AI consequences across three coupled registers—Environment (extraction, energy, ecologies), Ethics (labor, bias, governance, harm), and Epistemic (classification, knowledge, and what counts as real)." },
  { id: "ai_impact_environment", label: "Environment\n(AI Impact)",   cat: "framework",  weight: 1.3,
    desc: "The environmental register of AI—material extraction, energy use, water, carbon, and ecological damage hidden behind seemingly immaterial computation." },
  { id: "ai_impact_ethics",   label: "Ethics\n(AI Impact)",          cat: "framework",  weight: 1.3,
    desc: "The ethical register of AI—labor conditions, surveillance, bias, accountability, and the distribution of benefit and harm across bodies and communities." },
  { id: "ai_impact_epistemic", label: "Epistemic\n(AI Impact)",       cat: "framework",  weight: 1.3,
    desc: "The epistemic register of AI—how classification, datasets, and models organize perception, truth, memory, and what can be known or imagined." },
  ...
  { id: "crawford",           label: "Kate\nCrawford",                cat: "author",     weight: 1.3,
    desc: "Scholar of AI, politics, and culture—Atlas of AI and critical studies of extraction, labor, infrastructure, classification, and the material-ecological conditions of artificial intelligence.",
