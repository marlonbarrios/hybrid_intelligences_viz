...
function printCoverHtml(cover) {
  ...
  <section class="print-cover" aria-hidden="true">
    ...
    <dl class="meta-grid">
      ...
      <dd>Conceptual network · Ontology (JSON-LD / Turtle / OWL) · Conversational AI (Voice) · Video highlights · Synthetic Podcast (NotebookLM) · Slides (Creative B sessions, summer 2026) · Canvas · My Pendular Umwelt · Showcase</dd>
    </dl>
  </section>
`;
}
